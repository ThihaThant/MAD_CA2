      ...
      <View style={{ height: '80%',marginTop:20 }}>
        <ScrollView>
          <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center' }}>
            <View style={styles.items}><Entypo name='circle' size={40} style={{ margin: 10 }}></Entypo><View style={{ flex: 1, margin: 10 }}><Text>Placeholder Text</Text><Text>Placeholder Text </Text></View></View>
